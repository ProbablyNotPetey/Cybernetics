...
public class WidgetScale {
    private final AbstractScalableWidget widget;
    ...
    public WidgetScale(AbstractScalableWidget widget, float newScale, long startTime, int duration) {
        this(widget, newScale, startTime, duration, Easing.LINEAR);
    }
    public WidgetScale(AbstractScalableWidget widget, float newScale, long startTime, int duration, Easing easing) {
        this.widget = widget;
