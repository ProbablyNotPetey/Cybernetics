...
public class CyberwareInventoryOld {
    ...
    public CyberwareInventoryOld(CyberwareInventoryOld other) {
        this.copyFrom(other);
    }
...
//        }
    ...
    public void copyFrom(CyberwareInventoryOld other) {
        parts.clear();
...
//    }
    ...
    public static class CyberwareItemHandler extends ItemStackHandler {
